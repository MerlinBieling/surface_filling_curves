...
1. Fork `the repository <https://github.com/augmentedfabricationlab/surface_filling_curves>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/surface_filling_curves/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/surface_filling_curves/issues>`_. If you are proposing a feature:
